      ...
      <div className="space-y-10">
        <div className="space-y-4">
          ...
          <p className="max-w-2xl text-lg text-gray-600">
            We&apos;re catching up, not watching live. Pick a date range to browse completed matchups with no scores shown,
            read the game story like an article, then reveal the final when you&apos;re ready.
          </p>
        </div>
